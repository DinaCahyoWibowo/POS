        ...
        <div class="card-body">
            <form action="{{ route('admin.units.update', $unit) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input name="name" value="{{ old('name', $unit->name) }}" class="form-control @error('name') is-invalid @enderror">
                    @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label class="form-label">Code (optional)</label>
                    <input name="code" value="{{ old('code', $unit->code) }}" class="form-control @error('code') is-invalid @enderror">
